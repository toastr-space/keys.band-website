...
/>
<div class="w-full">
  <div class="flex flex-row items-center w-full p-4 px-8">
    ...
    <div class="">
      <a
        class="font-semibold hover:text-white text-right"
        target="_blank"
  ...
  <p class="max-w-xl mx-auto mb-8 mt-8 text-xl text-center xl:max-w-2xl intro">
  ...
  >
    <a
      class="mb-3 pb-16 pt-3 btn btn-primary text-black w-66 sm:mr-2 flex space-x-20"
  ...
  <div class="mb-16 border-b border-gray-800">
    ...
    <div class="flex flex-col mb-8 sm:flex-row w-full px-8">
      <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last px-4">
      ...
      >
        <p
          class="mb-2 text-sm font-semibold leading-none text-center text-purple-400 uppercase sm:text-left pr-6"
        >
    ...
    <div class="flex flex-col mb-8 sm:flex-row px-6">
      <div class="flex items-center text-center mb-8 sm:w-1/2 md:w-5/12">
      ...
      >
        ...
        <p class="text md:text-left text-center">
    ...
    <div class="flex flex-col mb-8 sm:flex-row px-6">
      <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last pl-6">
        <img class="rounded-sm" src="/img/frame-3.svg" alt="Screenshot 3" />
      </div>
      <div
        class="flex flex-col justify-center mb-8 sm:w-1/2 md:w-7/12 sm:pr-16 px-6"
      >
        <p
          class="mb-2 text-sm font-semibold leading-none text-center text-purple-400 uppercase sm:text-left pr-6"
        >
        ...
        <h3 class="title title-small sm:text-left md:text-4xl pr-6">
          Control Secure Request Access
        </h3>
        <p class="text md:text-left text-center pr-10">
  ...
  <div
    class="flex flex-col items-center sm:flex-row sm:justify-between pl-20 pr-20"
  >
  ...
  <div
    class="flex flex-col justify-between mb-8 text-center sm:flex-row pl-20 pr-20"
  >
